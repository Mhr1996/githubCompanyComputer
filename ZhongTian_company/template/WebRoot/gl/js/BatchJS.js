(function(w,d,$){
	...
	$.extend({
	    batchNewera:function(){batch.callback()}, //给复选框绑定事件 初始化
	    batchSave:function(){batch.save()},
	    batchGetLists:function(){return batch.getLists()},
	    batchClear:function(){batch.listClear()},
	    batchNum:function(){return batch.d}
	});
})(window,document,$);
